...
def run_inference_on_images(path, densecap_json = None, num_top_predictions = 5):
  ...
  # Read tags generated by Densecap
  if densecap_json:
    with open(densecap_json) as data_file:
  ...
  with tf.Session() as sess:
    ...
    for image in os.listdir(path):
      ...
      # Push to DB.
      table.insert_one( { "filename": image, "tensorflow_tag": tag, "tensorflow_confidence": float(confidence),
