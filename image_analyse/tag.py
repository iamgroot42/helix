...
class TensorLookup(object):
  ...
  def __init__(self,
    ...
    if not label_lookup_path:
      label_lookup_path = path_to + '/features/imagenet_2012_challenge_label_map_proto.pbtxt'
    if not uid_lookup_path:
      uid_lookup_path = path_to + '/features/imagenet_synset_to_human_label_map.txt'
